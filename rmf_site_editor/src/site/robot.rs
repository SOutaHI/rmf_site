...
use bevy::prelude::*;
use rmf_site_format::{RobotProperties, Pose};

pub fn add_robots_visuals(
    mut commands: Commands,
    robots: Query<(Entity, &Pose), Added<RobotProperties>>,
    assets: Res<SiteAssets>,
) {
    for (e, pose) in &robots {
        commands
            .entity(e)
        ...
        // let child = commands
        //     .spawn_bundle(Robot3dBundle {
        //         transform: robot_transform.transform(),
        //         robot: Robot {
        //             is_active: false,
        //             ..default()
        //         },
